    ...
    <form onSubmit={submit} className="space-y-4">
      <label className="block">
        ...
        <div className="relative">
          ...
          <input className="field pl-10" type="email" name="email" placeholder="name@agusanlending.com" autoComplete="username" required />
        </div>
      </label>
      <label className="block">
        ...
        <div className="relative">
          ...
          <input className="field pl-10" type="password" name="password" placeholder="Enter your password" autoComplete="current-password" required />
        </div>
      </label>
