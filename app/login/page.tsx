...
export default function LoginPage() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white px-4 py-8 sm:px-8 lg:items-start lg:justify-end lg:px-0 lg:pt-[38vh]">
      <Image
      ...
      <section className="relative z-10 w-full max-w-sm lg:mr-[12vw]">
